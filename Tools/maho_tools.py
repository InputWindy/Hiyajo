...
// The host = a scheduler (Driver): a dependency table (TExtension), a
// dynamically-installable application (IAssembly, NOT a singleton), and the
// drive policy (parallel scheduler — swap for FSerialScheduler to go serial).
class F{name}
	: public Maho::TExtension<{name_upper}_EXTENSIONS>
	, public virtual Maho::IAssembly
	, public Maho::Parallel::FParallelScheduler
{{
public:
