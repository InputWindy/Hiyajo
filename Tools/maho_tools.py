...
def create_project(
	...
	# Its base is FLayer<> directly; the selected plugin is mounted as a
	# dependency. All project logic is a layer; the EntryPoint exe loads its DLL.
	create_plugin(
		project_name, engine_root, description=description, plugins_dir=project_dir / "Plugins"
	)
