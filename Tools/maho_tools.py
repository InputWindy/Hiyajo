...
// The host: a plugin (TExtensionList) that is ALSO the loadable application
// (IAssembly → Main). Only applications inherit IAssembly; plain tools stay
// pure TExtension singletons.
class F{name}
	: public Maho::TExtensionList<{name_upper}_EXTENSIONS>
