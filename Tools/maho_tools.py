...
# PUBLIC so every Consumer (entry plugin + EntryPoint + sub-plugins) can just
# #include them directly.
target_link_libraries(Maho PUBLIC glm::glm nlohmann_json::nlohmann_json CLI11::CLI11)
