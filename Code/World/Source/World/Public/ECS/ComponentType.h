...
namespace Internal
{
	MAHO_WORLD_API FComponentTypeId NextComponentTypeId();

	MAHO_WORLD_API std::vector<std::size_t>& GetComponentSizeRegistry();

	MAHO_WORLD_API void RegisterComponentSize(FComponentTypeId Id, std::size_t Size);

	MAHO_WORLD_API [[nodiscard]] std::size_t GetComponentSize(FComponentTypeId Id);
}
