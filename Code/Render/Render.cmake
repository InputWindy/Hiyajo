...
FetchContent_Declare(
	imgui
	URL "${MAHO_GITHUB_MIRROR}https://github.com/ocornut/imgui/archive/refs/tags/v1.91.9-docking.tar.gz"
		"${MAHO_GITHUB_MIRROR}https://codeload.github.com/ocornut/imgui/tar.gz/refs/tags/v1.91.9-docking"
	URL_HASH SHA256=F272251572210D8089BE6E5D265F9C04F84C41654BA181611A4A196484B25483
	TIMEOUT 600
)
...
FetchContent_Declare(
	imguizmo
	# Branch-pinned (master): no URL_HASH — the archive moves with upstream.
	URL "${MAHO_GITHUB_MIRROR}https://github.com/CedricGuillemet/ImGuizmo/archive/refs/heads/master.tar.gz"
		"${MAHO_GITHUB_MIRROR}https://codeload.github.com/CedricGuillemet/ImGuizmo/tar.gz/refs/heads/master"
	TIMEOUT 600
)
...
FetchContent_Declare(
	...
	# Branch-pinned (develop): no URL_HASH — the archive moves with upstream.
	URL "${MAHO_GITHUB_MIRROR}https://github.com/thedmd/imgui-node-editor/archive/refs/heads/develop.tar.gz"
		"${MAHO_GITHUB_MIRROR}https://codeload.github.com/thedmd/imgui-node-editor/tar.gz/refs/heads/develop"
	TIMEOUT 600
)
...
FetchContent_Declare(
	implot
	URL "${MAHO_GITHUB_MIRROR}https://github.com/epezent/implot/archive/refs/tags/v0.16.tar.gz"
		"${MAHO_GITHUB_MIRROR}https://codeload.github.com/epezent/implot/tar.gz/refs/tags/v0.16"
...
FetchContent_Declare(
	imgui_file_dialog
	URL "${MAHO_GITHUB_MIRROR}https://github.com/aiekick/ImGuiFileDialog/archive/refs/tags/v0.6.7.tar.gz"
		"${MAHO_GITHUB_MIRROR}https://codeload.github.com/aiekick/ImGuiFileDialog/tar.gz/refs/tags/v0.6.7"
	URL_HASH SHA256=136E714965AFAEC2BAC857BF46A653FDD74A0BF493E281682706C604113026B8
	TIMEOUT 600
)
...
FetchContent_Declare(
	...
	# Branch-pinned (main): no URL_HASH — the archive moves with upstream.
	URL "${MAHO_GITHUB_MIRROR}https://github.com/juliettef/IconFontCppHeaders/archive/refs/heads/main.tar.gz"
		"${MAHO_GITHUB_MIRROR}https://codeload.github.com/juliettef/IconFontCppHeaders/tar.gz/refs/heads/main"
	TIMEOUT 600
)
...
target_include_directories(imgui
	PUBLIC
		...
		# that config includes Core/Misc/Export.h from Maho's public headers.
...
FetchContent_Declare(
	vma
	URL "${MAHO_GITHUB_MIRROR}https://github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator/archive/refs/tags/v3.2.1.tar.gz"
		"${MAHO_GITHUB_MIRROR}https://codeload.github.com/GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator/tar.gz/refs/tags/v3.2.1"
