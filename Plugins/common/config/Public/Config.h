 ...
 * A singleton service: Load parses an INI file, GetString/GetInt/... read,
 * SetString overrides at runtime. Reached via FConfig::Get().
 *
 ...
 */
class MAHO_CONFIG_API FConfig : public TSingleton<FConfig>
{
public:
	/** Clear all sections (ISingleton::Initiate/Shutdown). */
