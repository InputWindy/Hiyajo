...
target_include_directories(Resource PUBLIC
	...
	"${ENGINE_DIR}/Plugins/Common/Archive/Public"
)
...
set_target_properties(Resource PROPERTIES OUTPUT_NAME "FResourceSystem" PREFIX "")
target_link_libraries(Resource PUBLIC Name Paths Log Archive)
set_target_properties(Resource PROPERTIES FOLDER "Maho/Plugins/GameEngine/EngineCore")
...
#
# Texture decoding (WIC) lives in the Asset plugin (its Asset.cmake links the
# Windows codecs + COM).
