...
private:
	...
	/** Batches handed to the RHI server since startup (bumped BEFORE the marshal, see Tick). */
	std::atomic<std::uint32_t> FrameBatchesPosted{ 0 };
	std::uint32_t TicksSeen = 0;   // host-side counter, Tick-thread only
