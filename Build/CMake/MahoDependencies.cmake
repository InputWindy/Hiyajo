...
macro(maho_add_thirdparty_subdirectory)
	...
	get_property(_maho_tp_before GLOBAL PROPERTY BUILDSYSTEM_TARGETS)
	add_subdirectory(${ARGN})
	get_property(_maho_tp_after GLOBAL PROPERTY BUILDSYSTEM_TARGETS)
	foreach(_maho_tp_target IN LISTS _maho_tp_after)
		string(REGEX REPLACE "^BUILDSYSTEM_TARGET_" "" _maho_tp_name "${_maho_tp_target}")
		string(REGEX REPLACE "^BUILDSYSTEM_TARGET_" "" _maho_tp_before_stripped "${_maho_tp_before}")
		list(FIND _maho_tp_before "BUILDSYSTEM_TARGET_${_maho_tp_name}" _maho_tp_idx)
		if(_maho_tp_idx EQUAL -1 AND NOT _maho_tp_name STREQUAL "")
	...
	unset(_maho_tp_before_stripped)
	unset(_maho_tp_idx)
