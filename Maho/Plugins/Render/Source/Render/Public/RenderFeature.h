 ...
 */
class MAHO_RENDER_API IGameContextSlice
{
public:
...
struct MAHO_RENDER_API FGameFrameContext
{
 ...
 */
struct MAHO_RENDER_API FFrameContext
{
...
class MAHO_RENDER_API IRenderFeature
{
public:
